...
import com.energysolution.mvp.dto.ConfigurationReqDto;
import com.energysolution.mvp.model.ConfigurationModel;
import com.energysolution.mvp.service.ConfigurationService;
...
@Tag(name = "Configuration Controller", description = "Endpoints for managing configurations")
public class ConfigurationController {
    ...
    public ResponseEntity<ConfigurationModel> updateConfiguration(@PathVariable Long id, @Valid @RequestBody ConfigurationReqDto request) {
        ConfigurationModel updatedConfiguration = configurationService.updateConfiguration(id, request.getConfiguration());
     ...
     * @return HTTP status 204 with no content if the deletion was successful.
     */
