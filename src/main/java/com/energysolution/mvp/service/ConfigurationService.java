...
import com.energysolution.mvp.repository.ConfigurationRepository;
import com.energysolution.mvp.utils.mapper.ConfigurationMapper;
...
public class ConfigurationService {
     ...
     *
     * @param deviceId          The identifier of the device for which the configuration is created.
     ...
     * @return The updated ConfigurationModel object.
     * @throws EntityNotFoundException if no configuration is found with the provided id.
     */
